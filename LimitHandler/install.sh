...
wget -O /usr/bin/monitor_quota.py https://raw.githubusercontent.com/bimaVPN/v/main/LimitHandler/monitor_quota.py

# Download autokill.py
echo "✅ Downloading monitor_autokill.py..."
wget -O /usr/bin/monitor_autokill.py https://raw.githubusercontent.com/bimaVPN/v/main/LimitHandler/monitor_autokill.py
